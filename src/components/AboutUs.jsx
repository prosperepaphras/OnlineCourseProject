        ...
        <>
            <div className="bg-[#f7f7f8] px-[5%] space-y-10 pb-10">
                ...
                <div className="grid md:grid-cols-5 bg-white">
                    <div className="col-span-3 p-7 content-center ">
                        <p className=" text-[28px] md:text-[30px] lg:text-[40px] font-semibold ">
                            <span className='text-[#ff9500]'>Together</span>, let's shape the future of digital innovation
                        </p>
                        <p className=" text-[14px] md:text-[16px] lg:text-[18px]">Join us on this exciting learning journey and unlock your potential in design and development.</p>
                    </div>
                    <div className="hidden md:grid col-span-2 grid-cols-2">
                    <div className="col-span-1 h-full w-full" >
                        <img src={design} alt="" srcset="" className='h-full w-full' />
                    </div>
                    <div className=" col-span-1 flex items-center justify-center ">
                        <button type='submit' className="bg-[#ff9500] text-white p-3 rounded-lg">
                            Join Now
                        </button>
                    </div>
                    </div>
                    <div className="px-7 pb-5 md:hidden">
                        <button type='submit' className="bg-[#ff9500] text-white p-3 rounded-lg">
                            Join Now
                        </button>
                    </div>
